...
type (
	homestayOrderModel interface {
		...
		Update(ctx context.Context, session sqlx.Session, data *HomestayOrder) error
...
func (m *defaultHomestayOrderModel) Update(ctx context.Context, session sqlx.Session, newData *HomestayOrder) error {
